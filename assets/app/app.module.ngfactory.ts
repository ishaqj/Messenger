...
import * as import29 from './app.constants';
import * as import30 from './messages/message.service';
...
import * as import37 from './messages/messages.component.ngfactory';
...
import * as import47 from './messages/messages.component';
import * as import48 from './auth/authentication.component';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __Constants_44:import29.Constants;
  __MessageService_45:import30.MessageService;
  __ROUTER_CONFIGURATION_46:any;
  __LocationStrategy_47:any;
  __Location_48:import31.Location;
  __UrlSerializer_49:import32.DefaultUrlSerializer;
  __RouterOutletMap_50:import33.RouterOutletMap;
  __NgModuleFactoryLoader_51:import34.SystemJsNgModuleLoader;
  __ROUTES_52:any[];
  __Router_53:any;
  ...
  constructor(parent:import36.Injector) {
    super(parent,[
      import37.MessagessComponentNgFactory,
  ...
  get _EventManager_23():import16.EventManager {
    if ((this.__EventManager_23 == (null as any))) { (this.__EventManager_23 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_22,this.parent.get(import43.NgZone))); }
  ...
  get _Constants_44():import29.Constants {
    if ((this.__Constants_44 == (null as any))) { (this.__Constants_44 = new import29.Constants()); }
    return this.__Constants_44;
  }
  get _MessageService_45():import30.MessageService {
    if ((this.__MessageService_45 == (null as any))) { (this.__MessageService_45 = new import30.MessageService(this._Http_42,this._ErrorService_43,this._Constants_44)); }
    return this.__MessageService_45;
  }
  get _ROUTER_CONFIGURATION_46():any {
    if ((this.__ROUTER_CONFIGURATION_46 == (null as any))) { (this.__ROUTER_CONFIGURATION_46 = {}); }
    return this.__ROUTER_CONFIGURATION_46;
  }
  get _LocationStrategy_47():any {
    if ((this.__LocationStrategy_47 == (null as any))) { (this.__LocationStrategy_47 = import5.provideLocationStrategy(this.parent.get(import45.PlatformLocation),this.parent.get(import46.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_46)); }
    return this.__LocationStrategy_47;
  }
  get _Location_48():import31.Location {
    if ((this.__Location_48 == (null as any))) { (this.__Location_48 = new import31.Location(this._LocationStrategy_47)); }
    return this.__Location_48;
  }
  get _UrlSerializer_49():import32.DefaultUrlSerializer {
    if ((this.__UrlSerializer_49 == (null as any))) { (this.__UrlSerializer_49 = new import32.DefaultUrlSerializer()); }
    return this.__UrlSerializer_49;
  }
  get _RouterOutletMap_50():import33.RouterOutletMap {
    if ((this.__RouterOutletMap_50 == (null as any))) { (this.__RouterOutletMap_50 = new import33.RouterOutletMap()); }
    return this.__RouterOutletMap_50;
  }
  get _NgModuleFactoryLoader_51():import34.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_51 == (null as any))) { (this.__NgModuleFactoryLoader_51 = new import34.SystemJsNgModuleLoader(this._Compiler_18,this.parent.get(import34.SystemJsNgModuleLoaderConfig,(null as any)))); }
    return this.__NgModuleFactoryLoader_51;
  }
  get _ROUTES_52():any[] {
      if ((this.__ROUTES_52 == (null as any))) { (this.__ROUTES_52 = [[
        {
          path: '',
          redirectTo: '/messages',
          pathMatch: 'full'
        ...
        {
          path: 'messages',
          component: import47.MessagessComponent
        }
        ,
        {
          path: 'auth',
          component: import48.AuthenticationComponent,
  ...
  get _Router_53():any {
    if ((this.__Router_53 == (null as any))) { (this.__Router_53 = import5.setupRouter(this._ApplicationRef_17,this._UrlSerializer_49,this._RouterOutletMap_50,this._Location_48,this,this._NgModuleFactoryLoader_51,this._Compiler_18,this._ROUTES_52,this._ROUTER_CONFIGURATION_46)); }
  ...
  get _APP_BOOTSTRAP_LISTENER_55():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_55 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_55 = [import5.initialRouterNavigation(this._Router_53,this._ROUTER_CONFIGURATION_46)]); }
    return this.__APP_BOOTSTRAP_LISTENER_55;
  }
  get _AuthService_56():import35.AuthService {
    if ((this.__AuthService_56 == (null as any))) { (this.__AuthService_56 = new import35.AuthService(this._Http_42,this._ErrorService_43,this._Constants_44)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_3 = import5.provideForRootGuard(this.parent.get(import49.Router,(null as any)));
    ...
    this._ApplicationRef__16 = new import13.ApplicationRef_(this.parent.get(import43.NgZone),this.parent.get(import50.Console),this,this._ErrorHandler_13,this,this._ApplicationInitStatus_14,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_15);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import51.LOCALE_ID)) { return this._LOCALE_ID_11; }
    ...
    if ((token === import53.DOCUMENT)) { return this._DOCUMENT_20; }
    ...
    if ((token === import54.AnimationDriver)) { return this._AnimationDriver_25; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_26; }
    if ((token === import55.RootRenderer)) { return this._RootRenderer_27; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_28; }
    if ((token === import56.Sanitizer)) { return this._Sanitizer_29; }
    ...
    if ((token === import60.Http)) { return this._Http_42; }
    if ((token === import28.ErrorService)) { return this._ErrorService_43; }
    if ((token === import29.Constants)) { return this._Constants_44; }
    if ((token === import30.MessageService)) { return this._MessageService_45; }
    if ((token === import5.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_46; }
    if ((token === import46.LocationStrategy)) { return this._LocationStrategy_47; }
    if ((token === import31.Location)) { return this._Location_48; }
    if ((token === import32.UrlSerializer)) { return this._UrlSerializer_49; }
    if ((token === import33.RouterOutletMap)) { return this._RouterOutletMap_50; }
    if ((token === import61.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_51; }
    if ((token === import62.ROUTES)) { return this._ROUTES_52; }
    if ((token === import49.Router)) { return this._Router_53; }
    if ((token === import63.ActivatedRoute)) { return this._ActivatedRoute_54; }
    if ((token === import40.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_55; }
