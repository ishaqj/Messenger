...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  _ErrorComponent_12_4:import12.ErrorComponent;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_4 = this.renderer.createElement(this._el_2,'app-header',(null as any));
    this._appEl_4 = new import2.AppElement(4,2,this,this._el_4);
    var compView_4:any = import13.viewFactory_HeaderComponent0(this.viewUtils,this.injector(4),this._appEl_4);
    this._HeaderComponent_4_4 = new import10.HeaderComponent();
    ...
    this._el_7 = this.renderer.createElement(this._el_0,'hr',(null as any));
    this._text_8 = this.renderer.createText(this._el_0,'\n    ',(null as any));
    this._el_9 = this.renderer.createElement(this._el_0,'router-outlet',(null as any));
    this._appEl_9 = new import2.AppElement(9,0,this,this._el_9);
    this._RouterOutlet_9_5 = new import11.RouterOutlet(this.parentInjector.get(import14.RouterOutletMap),this._appEl_9.vcRef,this.parentInjector.get(import15.ComponentFactoryResolver),(null as any));
    this._text_10 = this.renderer.createText(this._el_0,'\n',(null as any));
    this._text_11 = this.renderer.createText(parentRenderNode,'\n',(null as any));
    this._el_12 = this.renderer.createElement(parentRenderNode,'app-error',(null as any));
    this._appEl_12 = new import2.AppElement(12,(null as any),this,this._el_12);
    var compView_12:any = import16.viewFactory_ErrorComponent0(this.viewUtils,this.injector(12),this._appEl_12);
    this._ErrorComponent_12_4 = new import12.ErrorComponent(this.parentInjector.get(import17.ErrorService));
    this._appEl_12.initComponent(this._ErrorComponent_12_4,[],compView_12);
    compView_12.create(this._ErrorComponent_12_4,[],(null as any));
    this.init([],[
      this._el_0,
      this._text_1,
      this._el_2,
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import12.ErrorComponent) && (12 === requestNodeIndex))) { return this._ErrorComponent_12_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._ErrorComponent_12_4.ngOnInit(); }
...
export function viewFactory_AppComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.AppComponent> {
  if ((renderType_AppComponent === (null as any))) { (renderType_AppComponent = viewUtils.createRenderComponentType('C:/dev/MEAN App/assets/app/app.component.html',0,import8.ViewEncapsulation.None,styles_AppComponent,{})); }
