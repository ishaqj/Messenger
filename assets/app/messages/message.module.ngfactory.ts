...
import * as import12 from '../app.constants';
class MessageModuleInjector extends import0.NgModuleInjector<import1.MessageModule> {
  ...
  get _MessageService_6():import7.MessageService {
    if ((this.__MessageService_6 == (null as any))) { (this.__MessageService_6 = new import7.MessageService(this.parent.get(import10.Http),this.parent.get(import11.ErrorService),this.parent.get(import12.Constants))); }
